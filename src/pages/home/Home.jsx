    ...
    <div className='home-container'>
      <div className='icons-container'>
        ...
        <div className='icon-item'>
          ...
          <p>
            Environmental Justice <br /> Evanston
          </p>
        </div>
        <div className='icon-item'>
        ...
        <section className='intro-section'>
          <div className='stats-container'>
            <div className='stats-header'>
              <h1>
                Since <span className='highlight'>2008</span> we've...
              </h1>
            </div>
            <div className='stats-box'>
              <ul className='stats-list'>
                <li>
                  ...
                  <b>Planted over 4200 trees</b>
                </li>
                <li>
                  <span className='bullet-point'>●</span>{' '}
                  <b>Saved 50 tons of food waste</b>
                </li>
                <li>
                  <span className='bullet-point'>●</span>{' '}
                  <b>Installed 70 gardens</b>
                </li>
              </ul>
            </div>
          </div>
      ...
      whenever that gets fixed could just change reference idk what the url is as of now*/}
          <a href='/scoreboard' className='learn-more-link'>
